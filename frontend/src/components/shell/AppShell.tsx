  ...
  if (!authed) {
    return (
      <div className="flex min-h-dvh flex-col">
        <header className="flex h-16 items-center px-5 md:px-8">
      ...
      <div className="relative flex min-w-0 flex-1 flex-col">
        ...
        */}
        <button
          ...
          className="fixed left-3 top-3 z-30 grid h-10 w-10 place-items-center rounded-full border border-border bg-surface/85 text-fg-muted shadow-soft backdrop-blur transition-all duration-fast ease-soft hover:text-fg active:scale-95 md:hidden"
        >
          <IcoMenu />
        </button>
        ...
        {collapsed && (
          <button
            ...
            className="animate-fade fixed left-3 top-3 z-30 hidden h-9 w-9 place-items-center rounded-full border border-border bg-surface/85 text-fg-faint shadow-soft backdrop-blur transition-all duration-fast ease-soft hover:text-fg md:grid"
          >
            <IcoPanelLeft />
          </button>
        )}
